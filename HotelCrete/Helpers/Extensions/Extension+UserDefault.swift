...
extension UserDefaults {
    ...
    func setHotelName(_ hotelName: String) {
        set(hotelName, forKey: UserDefaultsKeys.hotelName.rawValue)
        synchronize()
    }
    
    func getHotelName() -> String? {
        if let hotelName = string(forKey: UserDefaultsKeys.hotelName.rawValue) {
            return hotelName
        }
        return nil
    }
    
    func setHotelId(_ id: Int) {
        set(id, forKey: UserDefaultsKeys.hotelId.rawValue)
        synchronize()
    }
    
    func getHotelId() -> Int {
        return integer(forKey: UserDefaultsKeys.hotelId.rawValue)
    }
    
    func setHotelCode(_ code: Int) {
        set(code, forKey: UserDefaultsKeys.hotelCode.rawValue)
        synchronize()
    }
    
    func getHotelCode() -> Int {
        return integer(forKey: UserDefaultsKeys.hotelCode.rawValue)
    }
